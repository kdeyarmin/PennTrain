...
| `node scripts/check-dependencies.mjs` | L1 | live advisory audit | 0 high/critical | ❌ 6 HIGH (B8) |
...
| A7 | `node scripts/check-dependencies.mjs` | could not complete here (TLS timeout through the session proxy); CI's 2026-09-03 run: 6 HIGH |
