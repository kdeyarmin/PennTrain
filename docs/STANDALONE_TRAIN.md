...
6. Review evidence. Pending, rejected and void items earn no credit. Approved-pathway, annual fire and administrator-CE evidence needs a supporting document and qualification reference; a course completion alone is insufficient. Annual fire video requires a trained on-site instructor, documented as hybrid/classroom or verified external delivery; online-only evidence cannot be verified for that topic. Practical topics require observed-practice, on-the-job or hybrid delivery. Reviewed evidence is corrected by voiding it and creating a replacement.
