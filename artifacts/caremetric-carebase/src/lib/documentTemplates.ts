...
const CATEGORY_COMPLIANCE_METADATA: Record<TemplateCategory, TemplateComplianceMetadata> = {
  ...
  "Medication Compliance": { facilityTypes: ["PCH", "ALR"], citations: ["55 Pa. Code 2600.181-191", "55 Pa. Code 2800.181-191"], reviewCadence: "Daily open-event review and monthly pattern review", binderSection: "Medication system" },
...
export const DOCUMENT_TEMPLATES: DocumentTemplate[] = [
  ...
  },
  {
    ...
    body: {
      ...
      rows: [
        ["Before admission", "PCH: preadmission screening within 30 days before admission (2600.224(a)); DME within 60 days before or 30 days after (2600.22(2)). ALF: DME within 60 days before; initial assessment and preliminary support plan within 30 days before, or within 15 days after for a direct hospital admission, an escape from abuse or no alternative living arrangement (2800.22(a)(1)-(3)); certification that the residence can meet the resident's needs (2800.22(b))."],
        ["At admission (or within 24 hours)", "Resident contract signed before admission or within 24 hours after (2600.25(a) / 2800.22(a)(5)); rights and complaint procedures given, with signed acknowledgment (2600.41 / 2800.41); photo, emergency contacts, pharmacy/physician, personal needs, orders, diet."],
        ["Within 15 and 30 days", "PCH: initial assessment within 15 days after admission (2600.225(a)) and support plan within 30 days (2600.227(a)). ALF: final support plan within 30 days after admission (2800.227(a)). Each signed and consistent with care needs."],
        ["After any change", "DME, orders, support plan, emergency plan and service needs updated after falls, hospitalization or new condition; support plan revised within 30 days of a changed assessment (2600.227(c) / 2800.227(c))."],
        ["Annual/survey window", "DME current, assessment/support plan current, orders/med list match MAR, incidents resolved, rights documentation present. ALF: final support plan reviewed every quarter (2800.227(c))."],
      ],
    },
    footer: true,
  },
  ...
  },
  {
    ...
    body: {
      ...
      rows: [
        ["Diagnosis / clinical reason", "Ordered to treat the symptoms of a specific diagnosed mental, emotional or behavioral condition, or as pretreatment for an exam -- never to control acute or episodic aggressive behavior, which 2600.202(4) / 2800.202(4) prohibit. A symptom such as agitation is not a diagnosis (DHS regulatory clarification, May 2025)."],
        ["Admission and new-order review", "Medications the resident arrived with, and every new psychotropic, antipsychotic, antidepressant or anti-anxiety order, reviewed with the prescriber or pharmacist to confirm the need and the diagnosis."],
        ["Order details", "Dose, route, frequency, PRN criteria and maximum use are clear."],
        ["Before each PRN dose", "Triggers of the behavior documented, and less restrictive measures such as safe management techniques tried and recorded, before the PRN is given."],
        ["Monitoring", "Side effects, sedation, falls, appetite, mood/behavior and effectiveness are monitored; staff who administer these medications are educated on signs of adverse reactions."],
        ["Assessment and support plan", "Assessment and support plan document the medical history and need for each routine or PRN medication, plus behavior needs, supervision, risks and interventions."],
  ...
  },
  {
    ...
    body: {
      ...
      items: [
        ...
        "Criminal history check on file (2600.51 / 2800.51) and any other required clearances",
        "Initial orientation completed",
        "Direct care annual training completed: 12 hours in a PCH (2600.65(e)), 16 hours in an ALF (2800.65(h)), plus dementia hours where they apply",
  ...
  },
  {
    ...
    body: {
      ...
      items: [
        ...
        "Oral report to the area agency on aging immediately and written report within 48 hours (OAPSA, 6 Pa. Code 15.151)",
        "Sexual abuse, serious injury or suspicious death: also oral report to law enforcement immediately and to the Department of Aging the same business day, written reports within 48 hours (6 Pa. Code 15.152)",
        "Reportable incident filed with DHS within 24 hours (2600.16(c) / 2800.16(c))",
        "Resident and designated person notified immediately (2600.15(d) / 2800.15(d)); physician notified as the resident's care requires",
        "Begin written investigation log with dates/times/witnesses",
        "Staff involved: plan of supervision implemented or staff person suspended immediately (2600.15(b) / 2800.15(b)), and the plan or suspension notice sent to the DHS licensing office immediately (2600.15(c) / 2800.15(c))",
  ...
  // ---------- Admin, License & Reference Tools ----------
  {
    ...
    compliance: { facilityTypes: ["PCH"], citations: ["55 Pa. Code Ch. 2600"] },
    body: {
      kind: "reference", columns: ["Regulation area", "Survey focus", "Documentation to maintain", "Owner"],
      rows: [
        ["2600.11-16", "Licensure, abuse reporting, reportable incidents, capacity", "Current license, abuse report proof, incident reports, capacity census, SansWrite/incident proof", "Administrator / designee"],
        ...
        ["2600.41-44", "Rights notification, resident rights, complaints", "Signed rights acknowledgment, complaint log, rights training", "Administrator / rights lead"],
        ["2600.51-65", "Criminal history checks, administrator, staffing, training", "Criminal history checks, administrator training, staff roster, orientation, annual training, staff schedules", "Administrator / HR"],
        ...
        ["2600.224-227", "Preadmission screening, assessment and support plan", "Preadmission screening, assessment, support plan, updates after change in condition", "Resident care lead"],
        ["2600.251-254", "Resident records, retention and access", "Complete resident chart, retention proof, access and security, corrected records with proper process", "Records owner"],
      ],
    },
    footer: true,
  },
  ...
  },
  {
    ...
    body: {
      ...
      fixedFirstColumn: ["55 Pa. Code Chapter 2600 (PCH) or 2800 (ALF) regulations", "DHS/BHSL Regulatory Compliance Guide for that chapter", "PCH/ALF compliance forms page (DHS)", "Entrance Conference Guide", "Medication administration training guidance", "Annual BHSL report / top citations", "DHS listserv or regulatory clarifications"],
    },
    footer: true,
  },
  {
  ...
  },
  {
    ...
    body: {
      ...
      fixedFirstColumn: ["55 Pa. Code Chapter 2600 — Personal Care Homes / Chapter 2800 — Assisted Living Facilities", "PA DHS personal care home / assisted living licensing page", "PA DHS personal care home / assisted living compliance forms", "DHS/BHSL Regulatory Compliance Guide — Chapter 2600 or 2800", "DHS/BHSL Annual Report and PCH reports", "PCH Field Offices"],
    },
  },
  {
    code: "APP-02",
