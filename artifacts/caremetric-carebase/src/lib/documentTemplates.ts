...
export const DOCUMENT_TEMPLATES: DocumentTemplate[] = [
  ...
  },
  {
    ...
    note: "Open the DHS Forms Library in this app (Reporting & Documents) for direct download links to every current official form, organized the same way as this table. Before each annual survey window, verify against the current PA DHS PCH/ALF compliance forms page.",
    body: {
  ...
  },
  {
    ...
    body: {
      ...
      fixedFirstColumn: ["55 Pa. Code Chapter 2600 regulations", "DHS/BHSL Regulatory Compliance Guide", "PCH/ALF compliance forms page", "Entrance Conference Guide", "Medication administration training guidance", "Annual BHSL report / top citations", "DHS listserv or regulatory clarifications"],
    },
    footer: true,
  },
  {
  ...
  },
  {
    ...
    body: {
      ...
      fixedFirstColumn: ["55 Pa. Code Chapter 2600 — Personal Care Homes", "PA DHS PCH/ALF Licensing page", "PA DHS PCH/ALF Compliance Forms", "DHS/BHSL Regulatory Compliance Guide — Chapter 2600", "DHS/BHSL Annual Report and PCH reports", "PCH Field Offices"],
    },
  },
  {
    code: "APP-02",
