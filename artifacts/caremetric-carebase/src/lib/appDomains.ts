...
const APP_COMMAND_ACTIONS: AppCommandAction[] = [
  ...
  },
  {
    ...
    description: "Open the documentation binder workflow for survey-ready exports.",
...
export const APP_PAGES: AppPageDefinition[] = [
  ...
  { path: "/admin/closed-loop-compliance", label: "Closed-loop compliance", domain: "compliance", roles: PLATFORM_ADMIN, keywords: ["remediation", "incident intake", "move in", "historical report", "documentation room", "documentation room", "auditor"] },
  { path: "/admin/regulatory-copilot", label: "Citation-backed regulatory copilot", domain: "compliance", roles: PLATFORM_ADMIN, keywords: ["ai", "copilot", "citation", "regulation", "evidence", "readiness", "plan of correction", "mock survey", "effectiveness review"] },
  ...
  { path: "/app/evidence", label: "Documentation room", domain: "compliance", roles: REPORTING_ROLES, keywords: ["survey", "auditor", "guest access", "surveyor", "artifacts", "binder", "share", "evidence", "documentation room", "documentation room"] },
  ...
  { path: "/app/closed-loop-compliance", label: "Closed-loop compliance", domain: "compliance", roles: REPORTING_ROLES, keywords: ["remediation", "incident intake", "move in", "historical report", "documentation room", "documentation room", "auditor"] },
