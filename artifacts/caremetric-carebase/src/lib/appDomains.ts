...
const APP_COMMAND_ACTIONS: AppCommandAction[] = [
  ...
  },
  {
    ...
    label: "Open Import and Data Migration Center",
    description: "Download templates and manage mapped, validated, resumable imports.",
...
export const APP_PAGES: AppPageDefinition[] = [
  ...
  { path: "/admin/closed-loop-compliance", label: "Closed-loop compliance", domain: "compliance", roles: PLATFORM_ADMIN, keywords: ["remediation", "incident intake", "move in", "historical report", "documentation room", "auditor"] },
  ...
  { path: "/app/closed-loop-compliance", label: "Closed-loop compliance", domain: "compliance", roles: REPORTING_ROLES, keywords: ["remediation", "incident intake", "move in", "historical report", "documentation room", "auditor"] },
