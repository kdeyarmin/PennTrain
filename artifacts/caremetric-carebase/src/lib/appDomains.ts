...
export const APP_PAGES: AppPageDefinition[] = [
  ...
  { path: "/admin/closed-loop-compliance", label: "Closed-loop compliance", domain: "compliance", roles: PLATFORM_ADMIN, keywords: ["remediation", "incident intake", "move in", "historical report", "evidence room", "documentation room", "auditor"] },
  ...
  { path: "/app/evidence", label: "Documentation room", domain: "compliance", roles: REPORTING_ROLES, keywords: ["survey", "auditor", "guest access", "surveyor", "artifacts", "binder", "share", "evidence", "evidence room", "documentation room"] },
  ...
  { path: "/app/closed-loop-compliance", label: "Closed-loop compliance", domain: "compliance", roles: REPORTING_ROLES, keywords: ["remediation", "incident intake", "move in", "historical report", "evidence room", "documentation room", "auditor"] },
