...
export const PCH_ALR_OPERATIONS_ITEMS: PchAlrOperationsItem[] = [
  {
    ...
    summary: "Maps high-risk PCH/ALR obligations to the CareBase modules that hold live proof, due dates, and binder artifacts.",
  ...
  },
  {
    ...
    title: "PCH/ALR administrator qualification rule packs",
    summary: "Separates PCH and ALR administrator expectations, including orientation, approved-course/test proof, continuing education, and coverage evidence.",
