...
export const PCH_ALR_OPERATIONS_ITEMS: PchAlrOperationsItem[] = [
  {
    ...
    title: "Chapter 2600/2800 citation-to-documentation crosswalk",
    summary: "Maps high-risk PCH/ALF obligations to the CareBase modules that hold live proof, due dates, and binder artifacts.",
    citations: ["55 Pa. Code Ch. 2600", "55 Pa. Code Ch. 2800"],
    programs: ["PCH", "ALR"],
    evidenceSources: ["Inspection Readiness", "Compliance Binder", "Documentation Room", "Reports"],
  ...
  },
  {
    ...
    summary: "Coordinates resident admission, assessment/support-plan, rights, contract, designated-person, medication, signature, and copy-provided documentation.",
    citations: ["55 Pa. Code 2600.22, 2600.224–2600.227", "55 Pa. Code 2800.22, 2800.224–2800.227"],
    programs: ["PCH", "ALR"],
    ...
    surveyPrompt: "Open the resident packet and verify every admission/signature/state-form requirement is linked to signed documentation.",
  ...
  },
  {
    ...
    citations: ["55 Pa. Code 2600.181–2600.191", "55 Pa. Code 2800.181–2800.191"],
    programs: ["PCH", "ALR"],
  ...
  },
  {
    ...
    summary: "Separates PCH and ALF administrator expectations, including orientation, approved-course/test proof, continuing education, and coverage documentation.",
    citations: ["55 Pa. Code 2600.53, 2600.56, 2600.64", "55 Pa. Code 2800.53, 2800.56, 2800.64"],
    programs: ["PCH", "ALR"],
  ...
  },
  {
    ...
    summary: "Connects secured dementia care unit (PCH) and special care unit (ALF) designation to staff training, staffing coverage, policies, resident placement, and support-plan documentation.",
    citations: ["55 Pa. Code 2600.231–2600.239", "55 Pa. Code 2800.69, 2800.231–2800.239"],
    programs: ["PCH", "ALR"],
  ...
  },
  {
    ...
    title: "Inspection-day documentation package",
    summary: "Packages the entrance handoff, staff roster, resident roster, training, administrator, incident, medication, policy, and POC documentation into an expiring documentation-room collection.",
    citations: ["55 Pa. Code Ch. 2600", "55 Pa. Code Ch. 2800"],
    programs: ["PCH", "ALR"],
    evidenceSources: ["Documentation Room", "Compliance Binder", "Inspection Readiness", "Reports"],
    route: "/app/evidence",
    owner: "Binder owner",
  ...
  },
  {
    ...
    summary: "Tracks rights/complaint acknowledgements, ombudsman information, grievances, confidentiality, due dates, outcomes, and non-retaliation documentation.",
    citations: ["55 Pa. Code 2600.41–2600.44", "55 Pa. Code 2800.41–2800.44"],
    programs: ["PCH", "ALR"],
  ...
  },
  {
    ...
    citations: ["55 Pa. Code 2600.107, 2600.121–2600.133", "55 Pa. Code 2800.107, 2800.121–2800.133"],
    programs: ["PCH", "ALR"],
    ...
    surveyPrompt: "Show the latest emergency plan review, drill pattern, failed-drill follow-up, and staff training documentation.",
...
export function evidencePackageToText(sections: PchAlrEvidencePackageSection[]): string {
  return sections.map((section) => [
    ...
    `Documentation sources: ${section.evidenceSources.join("; ")}`,
