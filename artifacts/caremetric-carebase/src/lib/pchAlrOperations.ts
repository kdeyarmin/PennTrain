...
export const PCH_ALR_OPERATIONS_ITEMS: PchAlrOperationsItem[] = [
  ...
  },
  {
    ...
    summary: "Packages the entrance handoff, staff roster, resident roster, training, administrator, incident, medication, policy, and POC evidence into an expiring documentation-room collection.",
    citations: ["55 Pa. Code Ch. 2600", "55 Pa. Code Ch. 2800"],
    programs: ["PCH", "ALR"],
