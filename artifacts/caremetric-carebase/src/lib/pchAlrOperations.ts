...
export const PCH_ALR_OPERATIONS_ITEMS: PchAlrOperationsItem[] = [
  ...
  },
  {
    ...
    summary: "Connects dementia/special-care unit designation to staff training, staffing coverage, policies, resident placement, and support-plan documentation.",
