...
export const facilityAdminAgreementSections: LegalSection[] = [
  ...
  { title: "Services", body: [
    "CareMetric provides a healthcare learning, training, compliance, documentation, reporting, evidence-management, resident operations, and administrative workflow platform for Pennsylvania personal care homes, assisted living residences, and related care settings.",
