...
const ROLE_QUICK_START_ITEMS: Partial<Record<Role, RoleQuickStartItem[]>> = {
  ...
  org_admin: [
    ...
    { title: "Work the action plan", description: "Use the dashboard priority plan to drill into expired training, missing documentation, and low-scoring facilities.", href: "/app", cta: "Open dashboard" },
    { title: "Package proof", description: "Run reports or assemble binder documentation before survey, leadership, or board review.", href: "/app/reports", cta: "Run reports" },
  ],
  facility_manager: [
    ...
    { title: "Prepare documentation as work happens", description: "Use work items, alerts, and binder documentation instead of waiting for inspection week.", href: "/app/work", cta: "Open work queue" },
  ],
  trainer: [
