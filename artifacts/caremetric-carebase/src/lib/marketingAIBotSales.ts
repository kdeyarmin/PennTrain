...
const BOT_INTENTS: BotIntent[] = [
  {
    ...
    answer:
      "Here is the executive pitch: CareBase turns compliance from a last-minute documentation hunt into a live operating system. If your team is using spreadsheets, binders, email, and a separate LMS, CareBase gives leadership one place to run the facility, see risk, assign work, and prove readiness.",
    bullets: [
      ...
      "It showcases CareMetric's AI strength by drafting training content from your own materials while keeping review, approval, and documentation inside the workflow.",
    ],
    closer:
  ...
  },
  {
    ...
    answer:
      "If survey readiness is the buying trigger, CareBase is a strong fit. The platform is designed so documentation is captured while work happens, then packaged into binders, documentation rooms, and regulatory crosswalks when leadership or an auditor needs proof.",
    bullets: [
  ...
  },
  {
    ...
    closer:
      "If your buying committee says 'we already have training software,' ask whether that software can generate the full operational documentation story before survey day.",
  ...
  },
  {
    ...
    answer:
      "Security should help close confidence, not create buyer anxiety. CareBase is built around least-privilege access so sensitive operational and resident documentation is visible only to the roles and facilities that should see it.",
    bullets: [
  ...
  },
  {
    ...
    answer:
      "The ROI story is simple: CareBase pays for itself when it reduces manual compliance administration, prevents avoidable gaps, and lets managers fix risk earlier. The more facilities, employees, training requirements, and documentation workflows you manage, the stronger the value case becomes.",
    bullets: [
  ...
  },
  {
    ...
    answer:
      "A strong sales rollout starts small enough to win quickly and broad enough to prove value. CareBase can begin with a pilot facility or a focused compliance workflow, then expand across the organization once the documentation and manager routines are working.",
    bullets: [
  ...
  },
  {
    ...
    answer:
      "For multi-site buyers, CareBase is strongest as a leadership visibility layer. Instead of asking each facility for manual updates, executives and regional leaders can review readiness, overdue work, credentials, training, and documentation patterns across the organization.",
    bullets: [
      ...
      "The sales win is standardization: one operating rhythm, one documentation model, and fewer one-off spreadsheets per location.",
    ],
    closer:
  ...
  },
  {
    ...
    answer:
      "A demo should prove business value, not just show screens. The best CareBase demo uses your real buying questions: which documentation takes too long, which deadlines create risk, who needs visibility, and which workflows would make your managers faster.",
    bullets: [
  ...
  return withLeadContext(
    {
      role: "assistant",
      content:
        "As your CareBase customer service assistant: if your question touches compliance work, training proof, resident operations, documentation, or inspection readiness, the short version is that CareBase replaces scattered manual follow-up with one system that shows what is due, who owns it, and what proof is ready.",
      bullets: [
