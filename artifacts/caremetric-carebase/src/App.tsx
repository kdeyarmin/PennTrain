...
const ReleaseFlags = lazy(() => import("@/pages/admin/ReleaseFlags"));
...
function Router() {
  ...
  return (
    ...
    <Switch>
      ...
      <Route path="/admin/release-flags">
        {() => <ProtectedRoute component={ReleaseFlags} allowedRoles={PLATFORM_ADMIN} />}
      </Route>
