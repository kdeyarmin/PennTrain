...
const STATUS_CLASS: Record<string, string> = {
  ...
  completed_late: "bg-amber-100 text-amber-900 dark:bg-amber-950 dark:text-amber-200",
  resident_refused: "bg-orange-100 text-orange-900 dark:bg-orange-950 dark:text-orange-200",
  resident_unavailable: "bg-purple-100 text-purple-900 dark:bg-purple-950 dark:text-purple-200",
  not_completed: "bg-red-100 text-red-900 dark:bg-red-950 dark:text-red-200",
  completed_by_other: "bg-cyan-100 text-cyan-900 dark:bg-cyan-950 dark:text-cyan-200",
