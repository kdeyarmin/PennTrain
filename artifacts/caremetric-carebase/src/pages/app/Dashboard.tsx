...
export default function OrgDashboard() {
  const { user } = useAuth();
  const canRunReports = ["org_admin", "facility_manager", "auditor"].includes(user?.role ?? "");
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {/* /app/reports is REPORTS_VIEW_ROLES (org_admin / facility_manager / auditor); a trainer
            reaches this dashboard through ORG_ROLES and used to be bounced to /trainer here. */}
        {canRunReports && (
