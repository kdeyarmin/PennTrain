...
const INTENTS: Array<{ value: CopilotIntent; label: string; question: string; help: string }> = [
  ...
  { value: "citation_evidence", label: "Show citation evidence", question: "Show me the system evidence for this citation or regulatory topic.", help: "Matches governed sources, citation topics, and linked evidence rows." },
  ...
  { value: "mock_survey_request", label: "Mock-survey request", question: "Create a mock-survey document request from current due work and readiness gaps.", help: "Draft request only; evidence remains in its source modules." },
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Read-only synthesis over governed rule versions and facility-scoped CareBase evidence. Every answer carries its source, effective date, rule-pack version, evidence links, gaps, and authority label.</p>
      </div>
