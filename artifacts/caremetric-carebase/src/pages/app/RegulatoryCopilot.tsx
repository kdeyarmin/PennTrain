  ...
  return (
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>PA personnel templates are counsel-cleared and installable. Install and activate a PA PCH or PA ALF pack to enable full PA governance. The Ohio template demonstrates mechanism only and does not cover Pennsylvania. The copilot cannot close findings, approve plans, change resident records, decide incident reportability, invent citations, use superseded rules as current, or alter staffing eligibility.</AlertDescription>
      </Alert>
