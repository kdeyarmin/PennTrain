        ...
        <div style={{ maxWidth: "980px", margin: "0 auto", padding: "56px 24px" }}>
          ...
          <div style={{ border: "1px solid #dfe6ee", borderRadius: "14px", overflowX: "auto" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1.1fr 1.5fr 0.8fr", fontSize: "13.5px", minWidth: "640px" }}>
              <div style={{ padding: "12px 18px", fontFamily: "ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.08em", color: "#5d7084", borderBottom: "1px solid #eef2f6", background: "#fafbfc" }}>SETTING</div>
              <div style={{ padding: "12px 8px", fontFamily: "ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.08em", color: "#5d7084", borderBottom: "1px solid #eef2f6", background: "#fafbfc" }}>ANNUAL REQUIREMENT</div>
              <div style={{ padding: "12px 18px 12px 8px", fontFamily: "ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.08em", color: "#5d7084", borderBottom: "1px solid #eef2f6", background: "#fafbfc" }}>CITATION</div>
              {summaryRows.map(([setting, requirement, citation], index) => {
                ...
                return (
                  <div key={setting} style={{ display: "contents" }}>
                    ...
                    <div style={{ padding: "12px 18px 12px 8px", borderBottom: isLast ? undefined : "1px solid #eef2f6", fontFamily: "ui-monospace, monospace", fontSize: "12px", color: "#5d7084" }}>{citation}</div>
                  </div>
                );
              })}
            </div>
        ...
        <div style={{ maxWidth: "980px", margin: "0 auto", padding: "56px 24px" }}>
          ...
          <div style={{ background: "#ffffff", border: "1px solid #dfe6ee", borderRadius: "14px", overflow: "hidden" }}>
            <div style={{ display: "grid", gridTemplateColumns: "2fr 0.5fr 0.5fr", fontSize: "13.5px" }}>
              <div style={{ padding: "12px 18px", fontFamily: "ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.08em", color: "#5d7084", borderBottom: "1px solid #eef2f6", background: "#fafbfc" }}>REQUIRED SUBJECT</div>
              <div style={{ padding: "12px 8px", fontFamily: "ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.08em", color: "#5d7084", borderBottom: "1px solid #eef2f6", background: "#fafbfc", textAlign: "right" }}>PCH HRS</div>
              <div style={{ padding: "12px 18px 12px 8px", fontFamily: "ui-monospace, monospace", fontSize: "10.5px", letterSpacing: "0.08em", color: "#5d7084", borderBottom: "1px solid #eef2f6", background: "#fafbfc", textAlign: "right" }}>ALF HRS</div>
              ...
              <div style={{ padding: "10px 18px", borderBottom: "1px solid #eef2f6", color: "#5d7084" }}>+ Mental illness / intellectual disability, if served</div><div style={{ padding: "10px 8px", borderBottom: "1px solid #eef2f6", textAlign: "right", fontFamily: "ui-monospace, monospace", color: "#5d7084" }}>+0.75</div><div style={{ padding: "10px 18px 10px 8px", borderBottom: "1px solid #eef2f6", textAlign: "right", fontFamily: "ui-monospace, monospace", color: "#5d7084" }}>+1.00</div>
              <div style={{ padding: "10px 18px", color: "#5d7084" }}>+ Newly served population, when applicable</div><div style={{ padding: "10px 8px", textAlign: "right", fontFamily: "ui-monospace, monospace", color: "#5d7084" }}>+0.50</div><div style={{ padding: "10px 18px 10px 8px", textAlign: "right", fontFamily: "ui-monospace, monospace", color: "#5d7084" }}>+0.50–0.75</div>
            </div>
            <div style={{ padding: "12px 18px", borderTop: "1px solid #eef2f6", background: "#fafbfc", fontSize: "12px", color: "#5d7084" }}>Conditional topics add hours only when they apply — an N/A topic never produces fabricated credit. Up to 6 of the PCH hours may be supervised on-the-job training.</div>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: "980px", margin: "0 auto", padding: "56px 24px", display: "flex", flexDirection: "column", gap: "40px" }}>
          ...
          <div>
            ...
            <div style={{ marginTop: "16px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 300px), 1fr))", gap: "12px" }}>
              <div style={{ border: "1px solid #dfe6ee", borderRadius: "12px", padding: "18px" }}><div style={{ fontWeight: "700", fontSize: "14.5px", color: "#0d2742" }}>Nursing-home nurse aide</div><div style={{ fontFamily: "ui-monospace, monospace", fontSize: "11px", color: "#5d7084", marginTop: "2px" }}>42 CFR 483.95 · 28 Pa. Code 201.20</div><p style={{ margin: "8px 0 0", fontSize: "13px", color: "#44566b" }}>Tailored to each aide's most recent performance review and the facility assessment — not a generic annual class. Facility acceptance and documented attendance required.</p></div>
              <div style={{ border: "1px solid #dfe6ee", borderRadius: "12px", padding: "18px" }}><div style={{ fontWeight: "700", fontSize: "14.5px", color: "#0d2742" }}>Home health aide</div><div style={{ fontFamily: "ui-monospace, monospace", fontSize: "11px", color: "#5d7084", marginTop: "2px" }}>42 CFR 484.80 · 28 Pa. Code 601.35</div><p style={{ margin: "8px 0 0", fontSize: "13px", color: "#44566b" }}>RN-supervised and documented by the employing agency, covering care-plan boundaries, observation and escalation, home safety, and required skill work.</p></div>
              <div style={{ border: "1px solid #dfe6ee", borderRadius: "12px", padding: "18px" }}><div style={{ fontWeight: "700", fontSize: "14.5px", color: "#0d2742" }}>Hospice aide</div><div style={{ fontFamily: "ui-monospace, monospace", fontSize: "11px", color: "#5d7084", marginTop: "2px" }}>42 CFR 418.76</div><p style={{ margin: "8px 0 0", fontSize: "13px", color: "#44566b" }}>RN-supervised, adding hospice philosophy, the interdisciplinary group, grief and family support, active dying, and symptom escalation.</p></div>
            </div>
          </div>
          <div>
