  ...
  return useMutation({
    mutationFn: async (input: CreateResidentChangeEventInput) => {
      const { data, error } = await supabase.rpc("create_resident_change_event" as never, {
        ...
        p_emergency_transfer_destination: input.emergencyTransferDestination ?? undefined,
        p_monitoring_instructions: input.monitoringInstructions ?? undefined,
        p_monitoring_frequency: input.monitoringFrequency ?? undefined,
        p_monitoring_duration_hours: input.monitoringDurationHours ?? undefined,
        p_assigned_profile_id: input.assignedProfileId ?? undefined,
  ...
  return useMutation({
    mutationFn: async (input: {
      ...
      const { data, error } = await supabase.rpc("record_change_event_notification" as never, {
        ...
        p_notified_at: input.notifiedAt ?? undefined,
