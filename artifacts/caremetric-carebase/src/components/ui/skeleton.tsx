...
function Skeleton({
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* A single soft light sweep reads more "loading" than a flat pulse. Under
          prefers-reduced-motion the sweep is hidden entirely; the muted base still
          signals a placeholder. */}
