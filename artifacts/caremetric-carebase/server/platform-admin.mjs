...
export function createPlatformAdminRouter(options = {}) {
  ...
  return createProviderRouter({
    handlers: new Map([["read", createPlatformAdminHandler({ ...options, config })], ["command", createPlatformAdminCommandHandler({ ...options, config })],
      ["billing/command", createPlatformAdminBillingCommandHandler({ ...options, config })], ["configuration", createPlatformConfigurationHandler({ ...options, config })], ["training", createPlatformTrainingHandler({ ...options, config })]]), enabled: config.enabled,
    prefix: "/api/platform-admin/", routes: new Map([["read", { bytes: 2048, browser: false }], ["command", { bytes: 4096, browser: false }], ["billing/command", { bytes: 4096, browser: false }], ["configuration", { bytes: 4096, browser: false }], ["training", { bytes: 8192, responseBytes: 12000000, browser: false }]]),
