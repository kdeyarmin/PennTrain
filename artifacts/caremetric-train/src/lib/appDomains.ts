...
export const APP_PAGES: AppPageDefinition[] = [
  ...
  { path: "/app/pch-alr-operations", label: "PCH / ALR operations", domain: "compliance", roles: REPORTING_ROLES, keywords: ["personal care home", "assisted living", "chapter 2600", "chapter 2800", "survey", "medication safety", "resident rights", "emergency preparedness"] },
