...
const APP_COMMAND_ACTIONS: AppCommandAction[] = [
  ...
  {
    id: "open-evidence-room",
    label: "Build an evidence room",
    description: "Open Evidence Room to curate survey, audit, or corrective-action proof for governed guest sharing.",
    path: "/app/evidence",
    domain: "compliance",
    roles: REPORTING_ROLES,
    keywords: ["evidence room", "guest access", "surveyor", "auditor", "share", "packet"],
  },
  {
    id: "open-state-forms",
    label: "Review state forms",
    description: "Open State Forms to track regulator-facing forms through review, signature, filing, and renewal.",
    path: "/app/state-forms",
    domain: "residents",
    roles: REPORTING_ROLES,
    keywords: ["state forms", "dhs", "rasp", "asp", "renewal", "signature"],
  },
  {
    id: "review-confidential-intake",
    label: "Review confidential reports",
    description: "Open the protected intake queue for sensitive safety reports and follow-up triage.",
    path: "/app/confidential-incidents",
    domain: "compliance",
    roles: REPORTING_ROLES,
    keywords: ["confidential", "confidential intake", "safety report", "anonymous", "intake", "whistleblower", "triage"],
  },
  {
    id: "open-regulatory-crosswalk",
    label: "Open regulatory crosswalk",
    description: "Trace requirements, state forms, policies, and evidence back to their supporting citations.",
    path: "/app/regulatory-crosswalk",
    domain: "compliance",
    roles: REPORTING_ROLES,
    keywords: ["citation", "regulation", "crosswalk", "survey prep", "chapter 2600", "chapter 2800"],
  },
  {
    id: "open-pch-alr-operations",
    label: "Review PCH / ALF operations",
    description: "Open the operations snapshot for resident-facing and facility follow-up risk across PCH / ALF workflows.",
    path: "/app/pch-alr-operations",
    domain: "compliance",
    roles: REPORTING_ROLES,
    keywords: ["personal care home", "assisted living", "pch operations", "operations", "snapshot", "survey", "resident risk"],
  },
  {
    id: "run-reports",
  ...
  {
    id: "review-system-jobs",
    label: "Review system jobs",
    description: "Open the job control plane to inspect background work, retries, freshness, and failures.",
    path: "/admin/system-jobs",
    domain: "platform",
    roles: PLATFORM_ADMIN,
    keywords: ["jobs", "cron", "queue", "retry", "freshness", "health"],
  },
  {
    id: "open-enterprise-foundation",
    label: "Open enterprise foundation",
    description: "Manage identity domains, integrations, provisioning, billing entitlements, and tenant governance controls.",
    path: "/admin/enterprise",
    domain: "platform",
    roles: PLATFORM_ADMIN,
    keywords: ["enterprise", "sso", "scim", "entitlements", "integrations", "billing"],
  },
  {
    id: "open-support",
