  ...
  return (
    <MarketingLayout>
      <PageHero
        ...
        subtitle="Your training and compliance data is sensitive. CareMetric CareBase protects it with role-aware workflows, private evidence storage, and database-enforced access boundaries."
      />
