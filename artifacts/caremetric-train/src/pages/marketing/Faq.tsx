...
export default function Faq() {
  usePageMeta({
    ...
    description:
      "Answers to common questions about CareMetric CareBase: regulations covered, in-service hours by facility type, resident assessments, AI course generation, and more.",
    path: "/faq",
  });
