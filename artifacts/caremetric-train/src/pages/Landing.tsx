          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.02fr_0.98fr]">
            <div className="animate-in fade-in slide-in-from-bottom-2 duration-700">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-white/74">
                CareMetric Train is facility management software and a compliance command center for personal care homes, assisted living facilities, and care providers. It turns required in-services, credentials, practicums,
