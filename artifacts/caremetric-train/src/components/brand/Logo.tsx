...
/**
 * CareMetric Train brand assets. The emblem is a vector mark (public/logo-mark.svg);
...
/**
 * The emblem: nurse, stethoscope, home, and circuit motif from the CareMetric Train mark.
 *
 ...
 * (set it to white on dark surfaces, brand blue on light ones); "Train"
...
export function BrandName({ className, style }: { className?: string; style?: CSSProperties }) {
  return (
    <span className={className} style={style}>
      CareMetric <span style={{ color: BRAND_GRAY }}>Train</span>
    </span>
  );
}
