...
select e.id,e.organization_id,e.facility_id,'1990-01-01','high_school','direct_care','Synthetic fixture diploma verified',true,'4f000000-0000-4000-8000-000000000101'
from public.employees e where e.organization_id='4f000000-0000-4000-8000-000000000001';
...
where organization_id='4f000000-0000-4000-8000-000000000001' and credential_type='act34_criminal_history';
