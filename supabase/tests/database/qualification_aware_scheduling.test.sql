...
insert into public.schedules(id, organization_id, facility_id, title, period_start, period_end, created_by) values (
  ...
  '38000000-0000-4000-8000-000000000011', 'Qualification-aware schedule', public.pa_today()+1, public.pa_today()+7,
...
select is(
  public.preview_shift_assignment_candidates(
    '38000000-0000-4000-8000-000000000321', public.pa_today()+1,
...
select throws_ok(
  $$ select public.assign_employee_to_shift(
    ...
    public.pa_today()+1, '38000000-0000-4000-8000-000000000311', '38000000-0000-4000-8000-000000000301', null
  ) $$,
...
select assignment.* from public.assign_employee_to_shift(
  '38000000-0000-4000-8000-000000000321', '38000000-0000-4000-8000-000000000201',
  public.pa_today()+1, '38000000-0000-4000-8000-000000000311', '38000000-0000-4000-8000-000000000301', 'Qualified assignment'
) assignment;
...
select is(
  public.evaluate_shift_assignment_eligibility(
    ...
    public.pa_today()+1+'08:00'::time, public.pa_today()+1+'16:00'::time, array[]::uuid[]
  )->>'outcome',
...
select is(
  public.evaluate_shift_assignment_eligibility(
    ...
    public.pa_today()+1+'18:00'::time, public.pa_today()+1+'22:00'::time, array[]::uuid[]
  )->>'outcome',
...
insert into public.employee_availability_windows(
  ...
  public.pa_today()+3+'07:00'::time, public.pa_today()+3+'17:00'::time,
  '38000000-0000-4000-8000-000000000101'
);
select pg_temp.act_as('38000000-0000-4000-8000-000000000101');
select ok(
  (public.evaluate_shift_assignment_eligibility(
    '38000000-0000-4000-8000-000000000201', '38000000-0000-4000-8000-000000000011',
    '38000000-0000-4000-8000-000000000301', '38000000-0000-4000-8000-000000000311',
    public.pa_today()+3+'08:00'::time, public.pa_today()+3+'16:00'::time, array[]::uuid[]
...
insert into public.residents(
  ...
  '38000000-0000-4000-8000-000000000011', 'Resident', 'One', public.pa_today()-10, 'active', true
);
select pg_temp.act_as('38000000-0000-4000-8000-000000000101');
