...
insert into public.employees(id,organization_id,facility_id,first_name,last_name,job_title,status) values
 ('da250000-0000-4000-8000-000000000201','da250000-0000-4000-8000-000000000001','da250000-0000-4000-8000-000000000011','North','Learner','Aide','active'),
 ('da250000-0000-4000-8000-000000000202','da250000-0000-4000-8000-000000000001','da250000-0000-4000-8000-000000000012','South','Learner','Aide','active'),
 ('da250000-0000-4000-8000-000000000203','da250000-0000-4000-8000-000000000002','da250000-0000-4000-8000-000000000013','Other','Learner','Aide','active');
...
insert into public.course_assignments(id,organization_id,facility_id,employee_id,course_id,course_version_id,status,assigned_at,completed_at) values
 ('da250000-0000-4000-8000-000000000401','da250000-0000-4000-8000-000000000001','da250000-0000-4000-8000-000000000011','da250000-0000-4000-8000-000000000201','da250000-0000-4000-8000-000000000301','da250000-0000-4000-8000-000000000311','completed','2025-12-01T15:00:00Z','2026-01-01T02:00:00Z'),
...
insert into public.certificates(id,organization_id,facility_id,employee_id,course_id,course_assignment_id,issued_at,credential_number,slug) values
 ('da250000-0000-4000-8000-000000000501','da250000-0000-4000-8000-000000000001','da250000-0000-4000-8000-000000000011','da250000-0000-4000-8000-000000000201','da250000-0000-4000-8000-000000000301','da250000-0000-4000-8000-000000000401','2026-01-03T15:00:00Z','REPORT-CERT-1','training-report-one'),
...
select is(public.get_training_enrollment_report('da250000-0000-4000-8000-000000000001',p_limit=>1)->>'revision',public.get_training_enrollment_report('da250000-0000-4000-8000-000000000001',p_limit=>1,p_offset=>1)->>'revision','all pages describe the same report revision');
...
select throws_ok($$select public.get_training_enrollment_report('da250000-0000-4000-8000-000000000001',p_limit=>501)$$,'22023',null,'oversized page is rejected');
