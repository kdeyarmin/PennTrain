...
from public.employees e where e.id::text like '22000000%';
...
from public.employees where id::text like '22000000%';
...
where employee_id::text like '22000000%' and credential_type='act34_criminal_history';
