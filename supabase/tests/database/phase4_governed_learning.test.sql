...
insert into public.employees(id,organization_id,facility_id,profile_id,employee_number,first_name,last_name,email,hire_date,job_title,status) values('44000000-0000-4000-8000-000000000201','44000000-0000-4000-8000-000000000001','44000000-0000-4000-8000-000000000011','44000000-0000-4000-8000-000000000103','P4-L','Offline','Learner','p4-learner@test.local',public.pa_today()-30,'Caregiver','active');
select set_config('app.privileged_write','on',true);
...
-- PostgREST retries 40001 until the request times out (see 20260804050000).
