...
insert into public.organizations(id,name,slug,subscription_status,is_demo) values(pg_temp.id(1),'Campus current records','campus-current-records','active',true);
