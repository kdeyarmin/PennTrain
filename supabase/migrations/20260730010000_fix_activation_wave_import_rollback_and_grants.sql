-- Tighten activation-wave import control-plane privileges and allow the controlled
-- employee-import rollback path to remove its own bootstrap lifecycle evidence.
...
begin
  if tg_op = 'DELETE'
     ...
     and current_setting('app.allow_employee_import_rollback', true) = 'on'
