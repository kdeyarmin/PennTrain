...
-- upload size ceiling) at trimmed lengths safely under ~41MB each -- comfortably
-- under the ~50MB threshold block 8's 40.5MB success and the original block 5's
-- 61.5MB repeated failure bracket. Convert both back to video with the new HeyGen
