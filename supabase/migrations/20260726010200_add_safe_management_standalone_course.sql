...
insert into public.course_blocks (
  ...
  $jsonbody${"estimated_minutes": 3, "activity_type": "instruction", "content": "I'm Kevin. Twenty years in senior care, five running a nursing home, seventeen in hospice. This course is about the hardest moment of your week: a resident is angry, frightened, or refusing care, and you have about three seconds to decide what to do.\n\nLet me take something off your shoulders before we start.\n\nWhen a resident yells at you, pushes your hand away, or accuses you of stealing something you never touched, that is almost never about you. Behavior is communication. For a resident with dementia, it may be the only communication they have left. What looks like aggression is usually a person telling you that they're in pain, that they need the bathroom, that they're frightened by a stranger touching them, that they don't understand what's about to happen to them, or that they've lost control of their entire day and this is the last piece of it they have.\n\nIf you can hear the message, you can usually solve the problem. If you only hear the volume, you end up in a power struggle you cannot win, and neither can they.\n\nSo where does the skill actually live? Mostly before anything happens.\n\nIt lives in knowing your residents. That this gentleman gets agitated in the late afternoon, every day, and it isn't personal. That this woman doesn't like being approached from her left side because she can't see you coming. That this one has arthritis, so being taken by the arm genuinely hurts. That knowledge sits in support plans, in shift report, and in your coworkers' heads, and every minute you spend collecting it prevents an incident later.\n\nThen it lives in removing the triggers you can actually remove. Pain is the biggest one and the most missed, especially in residents who can't tell you they hurt. Arthritis, a pressure sore, constipation, a full bladder, a bad tooth. Any of those can show up as resistance to care or as striking out during personal care, and nobody in the room realizes it's pain.\n\nAfter pain: needing the toilet. Hunger. Being too hot or cold. Noise and crowding. Being rushed. Being touched without warning. Being given three instructions at once. A caregiver they don't recognize this morning. Change any one of those and the behavior very often changes with it.\n\nI want to be honest that none of this makes the moment easy. It makes it understandable, which is different. But understandable is what lets you stay calm, and staying calm is most of what works.\n\nIn the next section we'll go through what to actually do when something is already starting."}$jsonbody$::jsonb, null
);
...
insert into public.course_blocks (
  ...
  $jsonbody${"estimated_minutes": 3, "activity_type": "instruction", "content": "So something is already starting. Here's what actually works, and none of it is complicated.\n\nGive them room. Step back rather than in. Keep your hands visible and low. Approach from the front, where they can see you coming, and get to eye level if you can. If you're standing over somebody in a chair, you are already escalating, before you've said a word.\n\nSlow everything down. Your voice, your movements, your instructions. Short sentences. One idea at a time. Use their name. And then stop talking and let the silence do some work, because people tend to match the tone in the room, and most of us ruin that by filling the quiet with more explanation. More explanation is more pressure.\n\nAgree with the feeling, even when you can't agree with the facts. Arguing with a resident about whether their coat was stolen, or whether their mother is still alive, has never once helped anybody. You are not there to win the disagreement. You're there to get through the next ten minutes without anyone getting hurt.\n\nOffer real choices, and mean them. Now, or after lunch? A person who is fighting for control will very often accept the same care ten minutes later once it was their idea.\n\nTurn down the volume around the situation. The television, the noise, the audience. And send away the extra people who came to help and are now three more voices. One staff member talking works far better than three.\n\nAnd when it isn't working, walk away if it's safe to do so. Care that isn't urgent can wait. Come back in fifteen minutes, or ask a coworker to try. A resident who tells me no at nine o'clock might say yes to my coworker at nine fifteen, and there is nothing about that that reflects badly on me. Refusing care is a right, not a behavior problem, and forcing it is how people get hurt on both sides. What isn't optional is reporting the refusal, so the team can respond to it.\n\nKeep your own safety in the picture the whole time. Know where the door is. Don't let yourself get cornered. Don't turn your back on an escalating situation. Stay outside of striking range while you work. None of that is confrontational, and none of it is paranoid. It's the thing that lets you stay in the room long enough for the rest of it to work.\n\nOne more piece of practical advice from twenty years of watching this. The staff who are best at this aren't the calmest people by nature. They're the ones who decided in advance what they would do, so that they weren't inventing it at the worst possible moment."}$jsonbody$::jsonb, null
);
...
insert into public.course_blocks (
  ...
  $jsonbody${"estimated_minutes": 3, "activity_type": "instruction", "content": "Everything I've said so far is technique. This part is a boundary, and it does not flex for staffing, workload, or provocation. I'm going to be blunt about it.\n\nYou never use a physical restraint, and you never improvise one. Not a lap tray to keep somebody seated. Not a sheet tucked in tight. Not a chair pushed against a wall. Not holding a resident down so care can be finished. Pennsylvania regulates this narrowly, and your facility's policy will be narrower still, but forget the regulation for a second: restraints injure people, and they kill people, and they escalate the exact distress they're meant to control. If your facility has trained and authorized you in a specific approved intervention, you use it only as that training defines, only when somebody is in immediate danger, and only as long as that danger lasts.\n\nChemical restraint is the same answer. Medication is never used to manage a resident for staff convenience, and that includes suggesting somebody be medicated because they're difficult on your shift.\n\nAnd then there's coercion, which is the one crossed most casually, usually by tired people who don't think of it as abuse. You do not threaten, shame, mock, or bargain with something a resident is entitled to. Their food. Their belongings. Their visitors. Their call bell. Their bathroom. Those are rights, not leverage. Telling a resident they won't get help until they cooperate is not a management technique. It's abuse, it's reportable, and it carries the same obligation as physical harm.\n\nSame for ignoring a resident, talking about them like they aren't in the room, baby talk, rough handling, and retaliating against someone who complained.\n\nWhen there's immediate danger, protect people first. Move other residents away. Keep your distance. Call for help the way your facility trains you to. You are allowed to leave a situation to get help. Standing there alone trying to manage it isn't bravery, and nobody is asking you for it.\n\nAfterward, document what you observed, factually. Not that the resident was combative, which tells the next reader nothing. What was happening before it started, what they said and did, what you tried, how they responded, how it ended.\n\nAnd tell somebody, because new agitation in a resident who was calm last week is one of the most common signs of a urinary tract infection, pain, or a medication problem. Behavior treated as a personality trait instead of a symptom is how a real medical problem goes undiagnosed for weeks.\n\nThen check on yourself. Getting hit or screamed at is hard, even when you completely understand why it happened. Tell your supervisor. The people who last in this field aren't the ones who feel nothing. They're the ones who don't carry it home alone."}$jsonbody$::jsonb, null
);
