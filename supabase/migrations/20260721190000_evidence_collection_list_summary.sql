...
as $function$
  ...
  from filtered;
$function$;
revoke all on function public.get_evidence_collection_list_summary(uuid, uuid) from public, anon;
grant execute on function public.get_evidence_collection_list_summary(uuid, uuid) to authenticated, service_role;
