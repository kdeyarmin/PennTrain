...
insert into public.course_blocks (
  ...
  'b7837e34-1351-510b-b7eb-87d172d2a8b6'::uuid, '4b338aaa-5a7a-5a20-a602-d9a33d1f6482'::uuid, null, 'video', 2, $txt$The emergencies that do not sound an alarm$txt$,
  $jsonbody${"estimated_minutes": 3, "activity_type": "instruction", "script": "I'm Kevin. More than twenty years in senior care, five of them running a nursing home and seventeen in hospice. And I've been in the building for more of these than I'd like: power out in February, a water main break, a resident missing for forty minutes, a lockdown that turned out to be nothing and one that didn't.\n\nYou have a separate course on fire safety, and fire is the emergency everybody trains for. This one is about all the others. The ones that don't have an alarm attached and don't announce themselves.\n\nPennsylvania requires annual emergency preparedness training for exactly that reason. Your facility has a written emergency plan. That plan only works if the people on shift at two in the morning know what's in it, and in an actual emergency there is no time to read anything.\n\nSo let's start with your part of it, because good plans assign duties by shift and by area. Who sweeps which rooms. Who carries the current resident roster. Who grabs medications or the emergency bag. Who meets responders at the door. Who stays with residents at the assembly point. If you can't tell me what yours is for the shift you usually work, ask this week. Not during the event.\n\nThen there's the resident information that changes everything you do, and nobody has time to look it up later. Which residents can't move independently. Which residents depend on electricity to stay well, meaning an oxygen concentrator, a CPAP, a feeding pump, a powered mattress. Which residents wander. Which ones have diabetes or a seizure disorder or dementia that changes how they'll handle disruption, heat, or cold. Which ones can't hear you or can't see you well enough to follow instructions in a dark hallway.\n\nAnd know your building. Where the utility shutoffs are. Where the flashlights are, and whether they actually work, which you want to find out now instead of in the dark. What the doors do when the power fails, especially the electronically secured ones. Which areas are safest in severe weather. How you'd move residents between floors if the elevators are out.\n\nLast piece of the framing, and it matters: know your limits inside the plan. You are not the incident commander, the fire department, security, or the clinician. Your job is to protect the residents in front of you, follow your assignment, communicate accurately, and get help fast. Improvising outside your assignment is how staff end up in the wrong hallway while somebody's room goes unchecked.\n\nNext we'll walk through the ones that actually happen.", "heygen": {"video_id": "29ecef6326724dd2a9e7b97923d81fc5", "status": "processing", "avatar_id": "3fd2086f9f31438cb28ae57134b6affa", "voice_id": "2ba78236f7a64ca8b182d14c23399c88", "requested_at": "2026-07-25T05:05:00Z"}}$jsonbody$::jsonb, $txt$https://xsqobvvreaovwibxwyvv.supabase.co/storage/v1/object/public/course-videos/system/b7837e34-1351-510b-b7eb-87d172d2a8b6.mp4$txt$
);
...
insert into public.course_blocks (
  ...
  '0d5803e9-dbdb-5938-b341-3ed3e0f2012d'::uuid, '4b338aaa-5a7a-5a20-a602-d9a33d1f6482'::uuid, null, 'video', 4, $txt$Power, weather, water, and a missing resident$txt$,
  $jsonbody${"estimated_minutes": 3, "activity_type": "instruction", "script": "Let's walk through the ones that actually happen, because most emergencies in a residential building aren't dramatic. They're utility failures that become dangerous because of who lives there.\n\nPower loss is the most common. Your building probably has a generator, and you need to know what it carries and what it doesn't. Which outlets are on emergency power and which are not, because that decides whether an oxygen concentrator or a CPAP or a feeding pump keeps running. Know which residents depend on those devices, what the backup is for each one, and how long that backup lasts. Check on those residents first. And remember a power failure can take the heat, the cooling, the elevators, the electronic locks, the call bell system, and the medication refrigerator with it, so it's never just about the lights. And never, ever use candles or an open flame as emergency lighting.\n\nHeat and cold are genuinely dangerous for older adults, who regulate temperature poorly and often won't tell you they're uncomfortable. In heat, watch for confusion, weakness, dizziness, and hot dry skin, get people out of the sun and the warmest rooms, and push fluids the way each care plan allows. In cold, watch for shivering that stops, sleepiness, and confusion, and add layers. In both cases report the change rather than deciding what it is, because those presentations overlap with infection and medication effects.\n\nWater loss means no handwashing, no flushing, no cooking, no bathing. Know where your bottled water, sanitizer, and hygiene supplies are kept. That's the whole preparation.\n\nSevere weather. Know your shelter areas, usually interior rooms away from windows on the lowest safe floor. And be realistic: moving a building full of people who use walkers and wheelchairs takes far longer than any warning gives you. Start early. If you ever evacuate to another site, the three things that matter most are an accurate resident count, medications, and records leaving with the residents.\n\nAnd then a missing resident, which the field calls elopement, and which is one of the most dangerous events in a building like yours. Prevention is part of every shift: know who's at risk of leaving, know your alarmed doors and secured exits, and never prop a door or disable an alarm because your hands are full. If you can't locate somebody, notify immediately. Do not spend twenty minutes quietly looking and hoping it resolves before anyone finds out. Minutes matter, because a confused resident outside in traffic, in heat, or in cold is in real danger right now.\n\nAcross every one of these, the rule is the same: notify, don't investigate. Getting the right people involved fast is your job. Figuring out what happened is theirs.", "heygen": {"video_id": "b191d0ff7cd74ef8b5651fa56f9231b7", "status": "processing", "avatar_id": "3fd2086f9f31438cb28ae57134b6affa", "voice_id": "2ba78236f7a64ca8b182d14c23399c88", "requested_at": "2026-07-25T05:05:00Z"}}$jsonbody$::jsonb, $txt$https://xsqobvvreaovwibxwyvv.supabase.co/storage/v1/object/public/course-videos/system/0d5803e9-dbdb-5938-b341-3ed3e0f2012d.mp4$txt$
);
...
insert into public.course_blocks (
  ...
  'fe74a62c-58b2-5651-b189-6927e22c4912'::uuid, '4b338aaa-5a7a-5a20-a602-d9a33d1f6482'::uuid, null, 'video', 6, $txt$Counts, communication, documentation, and drills$txt$,
  $jsonbody${"estimated_minutes": 3, "activity_type": "instruction", "script": "I want to close with four things that run through every emergency, no matter which one you get.\n\nOne. An accurate count of residents is the single most valuable piece of information anybody can hand a responder. It tells them whether somebody is still inside, and that decides everything they do next. Know where the current roster lives. Know it changes with admissions, discharges, hospital transfers, and residents out with family. Count against it, and report the result to whoever is coordinating, including the resident who's at an appointment, because an unexplained absence gets treated as a person missing in the building.\n\nTwo. Communication goes up the chain, fast, and it goes up as facts rather than conclusions. Tell your supervisor what you observed, not what you think it means. And do not call families yourself, and do not post anything about it. I know that sounds cold when a daughter is on the phone asking about her mother, and I've had that call. But residents' privacy doesn't pause during an emergency, and family notification comes from administration so that families get accurate information instead of six partial versions from six people.\n\nThree. Documentation. What you observed, what you did, when, and who you notified. Facilities have reporting obligations to the Department of Human Services for certain events, and those reports get built out of what staff wrote down. If it isn't written, it effectively didn't happen.\n\nFour. Drills are the training. Take them seriously, including the ones that land at the worst possible moment, and move at the pace you'd actually move. The entire point of a drill is to find out what doesn't work while it's still safe to find out. So when the stairwell door sticks, when a flashlight is dead, when the roster is out of date, when nobody knew who was supposed to meet the ambulance, say so in the debrief. That is not complaining. That is the exercise working.\n\nYour facility's written plan controls over anything I've said here, and it should, because I don't know your building and it does.\n\nWhat I want you to leave with is simpler than the plan. Know your building. Know which of your residents depend on something to stay well. Know your assignment. Because in every one of these events, resident safety depends far less on the plan sitting in a binder than on what the person standing in the hallway already knows.\n\nTonight, that person is you.", "heygen": {"video_id": "6c3090a2cd4149dda70513b7eed65f11", "status": "processing", "avatar_id": "3fd2086f9f31438cb28ae57134b6affa", "voice_id": "2ba78236f7a64ca8b182d14c23399c88", "requested_at": "2026-07-25T05:05:00Z"}}$jsonbody$::jsonb, $txt$https://xsqobvvreaovwibxwyvv.supabase.co/storage/v1/object/public/course-videos/system/fe74a62c-58b2-5651-b189-6927e22c4912.mp4$txt$
);
