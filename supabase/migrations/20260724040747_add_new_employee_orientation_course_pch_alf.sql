...
insert into public.courses (
  ...
  $txt$PA-DHS-ORIENT-NEW-EMPLOYEE$txt$, null
);
...
insert into public.course_blocks (
  ...
  'a37ce65f-b5e0-4ddd-9181-92c32d57c20f'::uuid, '23ca08d4-afef-4b88-9db6-2f693d58588f'::uuid, null, 'text', 2, $txt$Welcome to CareBase: why your first days matter$txt$,
  $jsonbody${"estimated_minutes": 8, "activity_type": "instruction", "content": "Hi. I'm Kevin Deyarmin, and I want to personally welcome you to your first day.\n\nFor over twenty years, I've worked in senior care. Five years running a nursing home. The last seventeen in hospice. I've also spent nearly ten years as a certified medication administration trainer, and I've walked into more personal care homes and assisted living facilities than I can count, usually as the person a facility called when something needed to be fixed. So when I tell you that your first few days on this job matter more than almost any other days you'll work here, I mean it from experience, not from a textbook.\n\nHere's why. On your first day, you don't yet know this building. You don't know where the exits are, who your residents are, or what to do if something goes wrong. And the residents you're about to meet, in a personal care home or an assisted living facility, are people who need help with daily life by definition. Some can't get themselves out of a building quickly on their own. Some can't tell you clearly that something is wrong. That combination, an unfamiliar new worker and residents who depend on that worker, is exactly why Pennsylvania law doesn't wait for your facility to get around to training you eventually. It requires fire safety and emergency orientation before or during your very first work day, and a fuller orientation within your first forty scheduled working hours.\n\nThis course is that orientation. I'm walking you through it personally, on video, because I don't think compliance training should feel like a formality you click past. I think it should feel like what it actually is: the difference between a resident getting help in time and a resident not getting help in time, and the difference between you knowing exactly what to do and you freezing because nobody ever told you.\n\nOver the next few sections, you're going to learn what to do in an emergency, from the moment an alarm sounds to the moment residents are safely out and accounted for. You're going to learn about resident rights, and what it actually means to treat someone with dignity when they can no longer do everything for themselves. You're going to learn how to recognize abuse, neglect, and exploitation, and exactly what the law requires you to do the moment you see it, because in this field, staying silent is not a neutral choice. You're going to learn the boundaries of your role right now, on day one, before you've completed your full training, and exactly when to stop and get help instead of guessing. And you're going to work through two realistic scenarios, the kind of thing that actually happens on a first shift, so this isn't just words on a screen.\n\nI want to be honest with you about something. This course will not make you a fully trained direct care worker. Nobody becomes that in three hours, and Pennsylvania doesn't expect you to. What it will do is make sure that from your very first shift, you know how to help keep residents safe, you know your own limits, and you know exactly who to go to when you're not sure. That is what orientation is for, and it's the same standard I held every new hire to throughout my own career running care programs.\n\nOne more thing. At the end of this course, you'll sit down with your supervisor and go through a checklist that's specific to this building: where the alarms are, who your residents are, where things are kept. That part matters just as much as this video does. Take your time with all of it, ask questions whenever something isn't clear, and thank you for choosing to do this work. It is harder than people on the outside realize, and it matters more than people on the outside realize. Let's get started."}$jsonbody$::jsonb, null
);
...
-- time should report zero issues except the two still-processing video URLs, which
-- the follow-up migration addresses once poll-heygen-video-statuses has re-hosted them.
do $sanity$
declare
  v_issues text[];
begin
