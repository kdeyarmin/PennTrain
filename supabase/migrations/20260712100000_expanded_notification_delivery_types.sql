...
insert into public.notification_templates (
  ...
  (null, 'course_assigned', 'email', 1, 'active',
   ...
   'A new training course was assigned to you. Sign in to CareMetric CareBase to see your assignment and its due date.',
   '{}'::text[], now()),
  (null, 'policy_attestation_assigned', 'email', 1, 'active',
   'A policy requires your attestation',
   'A policy attestation was assigned to you. Sign in to CareMetric CareBase to review and sign it securely.',
   '{}'::text[], now());
