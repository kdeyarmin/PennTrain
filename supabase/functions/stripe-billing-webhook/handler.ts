...
export interface StripeBillingWebhookDependencies {
  createClient: ClientFactory;
  getEnv?: (name: string) => string | undefined;
  verifySignature?: typeof verifyPhase2StripeSignature;
  sha256?: typeof phase2BillingSha256;
}
...
export function createStripeBillingWebhookHandler({
  createClient,
  getEnv = (name) => Deno.env.get(name),
  verifySignature = verifyPhase2StripeSignature,
  sha256 = phase2BillingSha256,
