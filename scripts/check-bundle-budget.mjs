...
const budgets = {
  ...
  // environmental work-order and emergency-operations features; raised 2710 -> 2760 after
  // the emergency-operations and environmental-work-orders branches were both merged into
  // main; measured combined bundle is 2755.7 KiB; raised 2760 -> 2790 after the resident
  // administrative master workspace (identity, contacts, legal, payer, directives, rights,
  // contracts, history) merged in and the measured combined bundle reached 2787.2 KiB;
